...
| `CLOUDSTIC_OBJECT_CACHE_DIR` | Directory for the local object cache (`DiskCacheStore`); flag `-object-cache-dir`. Empty, the default, disables it. |
