...
func TestSource_Walk_SkipMode(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestSource_Walk_SkipXattrs(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestSource_Walk_SkipFlags(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestSource_Walk_XattrNamespaces(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestSource_Walk_Xattr_RoundTrip(t *testing.T) {
	tmpDir := t.TempDir()
	filePath := filepath.Join(tmpDir, "file.txt")
...
func TestSource_Info_FsType(t *testing.T) {
	tmpDir := t.TempDir()
	s := New(tmpDir)
	info := s.Info()
